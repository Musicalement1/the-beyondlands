...
public class TBlStructureSets {
    ...
    public static void bootstrap(BootstrapContext<StructureSet> context) {
        ...
        context.register(
                ASHLING_RUINS_SET,
                new StructureSet(
                        List.of(new StructureSet.StructureSelectionEntry(structures.getOrThrow(TBlStructures.ASHLING_RUINS), 1)),
        ...
        context.register(
                LAB_RUINS_SET,
                new StructureSet(
                        List.of(new StructureSet.StructureSelectionEntry(structures.getOrThrow(TBlStructures.LAB_RUINS), 1)),
                        new RandomSpreadStructurePlacement(
                                30,
                                10,
                                RandomSpreadType.LINEAR,
        ...
        context.register(
                WATCHTOWER_SET,
                new StructureSet(
                        List.of(new StructureSet.StructureSelectionEntry(structures.getOrThrow(TBlStructures.WATCHTOWER), 1)),
                        new RandomSpreadStructurePlacement(
                                32,
                                20,
                                RandomSpreadType.LINEAR,
