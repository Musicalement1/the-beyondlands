...
public class TBlConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldLithiumOres = List.of(
                OreConfiguration.target(stoneReplaceables, TBlBlocks.LITHIUM_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplaceables, TBlBlocks.LITHIUM_DEEPSLATE_ORE.get().defaultBlockState()));
        ...
        register(context, ASH_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(TBlBlocks.ASH_LOG.get()),
                new ForkingTrunkPlacer(4, 4, 3),

                BlockStateProvider.simple(TBlBlocks.ASH_LEAVES.get()),
                ...
                new BlockPileConfiguration(
                        ...
                        new WeightedStateProvider(
                                SimpleWeightedRandomList.<BlockState>builder()
                                        .add(TBlBlocks.CORIUM.get().defaultBlockState(), 49)
        ...
        register(
                context,
                HUGE_GREEN_MUSHROOM,
                TBlFeatures.HUGE_GREEN_MUSHROOM.get(),
                new HugeMushroomFeatureConfiguration(
                        BlockStateProvider.simple(TBlBlocks.GREEN_MUSHROOM_BLOCK.get()),
            ...
            Feature.RANDOM_PATCH,
                FeatureUtils.simplePatchConfiguration(
                        ...
                        new SimpleBlockConfiguration(
                                BlockStateProvider.simple(TBlBlocks.GREEN_MUSHROOM.get())
                        ),
                        List.of(),
                        16
                )
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(TBL.MOD_ID, name));
    }
