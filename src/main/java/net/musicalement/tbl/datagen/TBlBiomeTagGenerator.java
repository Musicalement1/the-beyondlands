...
public class TBlBiomeTagGenerator extends BiomeTagsProvider {
    ...
    public TBlBiomeTagGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, ExistingFileHelper helper) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(IS_BL_OR_OVERWORLD)
                ...
                .addTag(TBlBiomeTagGenerator.IS_BL);
