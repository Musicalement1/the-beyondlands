...
public class TBlChestLootProvider implements LootTableSubProvider {
    ...
    public TBlChestLootProvider(HolderLookup.Provider registries) {
                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(TBlItems.STEEL_INGOT.get())
                                                .setWeight(20)
                                                .apply(SetItemCountFunction.setCount(
                                                        UniformGenerator.between(1, 4))))
                                        .add(LootItem.lootTableItem(TBlItems.LITHIUM_BATTERY.get())
                                                .setWeight(20)
                                                .apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.5F, 1.0F)))
                                                .apply(SetItemCountFunction.setCount(
                                                        UniformGenerator.between(1, 2))))
                                        .add(LootItem.lootTableItem(TBlItems.LITHIUM_BATTERY_STACK.get())
                                                .setWeight(5)
                                                .apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.5F, 1.0F)))
                                                .apply(SetItemCountFunction.setCount(
                                                        UniformGenerator.between(1, 2))))
                                        .add(LootItem.lootTableItem(TBlItems.PEPPER_SEEDS.get())
                                                .setWeight(25)
                                                .apply(SetItemCountFunction.setCount(
        ...
        consumer.accept(
                ...
                .withPool(
                        ...
                        .setRolls(UniformGenerator.between(2.0f, 5.0f))
                                ...
                                .add(LootItem.lootTableItem(TBlItems.STEEL_CHESTPLATE.get())
                                        .setWeight(5)
                                        .apply(SetItemCountFunction.setCount(
                                ...
                                .add(LootItem.lootTableItem(TBlItems.ENCHANTITE_SHARD.get())
                                        .setWeight(7)
                                        .apply(SetItemCountFunction.setCount(
                                                UniformGenerator.between(1, 2))
                                        )
