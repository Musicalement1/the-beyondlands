...
public class TBlAdvancementGenerator implements NeoForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries,
        ...
        AdvancementHolder root = Advancement.Builder.advancement()
                .display(
                        new ItemStack(TBlItems.LITHIUM.get()),
        ...
        AdvancementHolder obtain_raw_lithium = Advancement.Builder.advancement()
                .parent(root)
                .display(
                        new ItemStack(TBlBlocks.LITHIUM_ORE.get()),
                ...
                .addCriterion("pickup_raw_li",
                        InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.RAW_LITHIUM.get()))
        ...
        AdvancementHolder smelt_lithium = Advancement.Builder.advancement()
                ...
                .addCriterion("pickup_li",
                        InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.LITHIUM.get()))
        ...
        AdvancementHolder obtain_steel = Advancement.Builder.advancement()
                ...
                .display(
                        new ItemStack(TBlItems.STEEL_INGOT.get()),
                ...
                .addCriterion("steel",
                        InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.STEEL_INGOT.get())
                )
        ...
        AdvancementHolder make_steel_armor = Advancement.Builder.advancement()
                .parent(obtain_steel)
                .display(
                        new ItemStack(TBlItems.STEEL_CHESTPLATE.get()),
                ...
                .addCriterion("h", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.STEEL_HELMET))
                .addCriterion("c", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.STEEL_CHESTPLATE))
                .addCriterion("l", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.STEEL_LEGGINGS))
                .addCriterion("f", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.STEEL_BOOTS))
        ...
        AdvancementHolder make_battery = Advancement.Builder.advancement()
                .parent(obtain_steel)
                .display(
                        new ItemStack(TBlItems.LITHIUM_BATTERY.get()),
                ...
                .requirements(AdvancementRequirements.Strategy.OR)
                .addCriterion("bat", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.LITHIUM_BATTERY))
                .addCriterion("sbat", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.LITHIUM_BATTERY_STACK))
                .addCriterion("batb", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.LITHIUM_BATTERY_BOOSTED))
                .addCriterion("sbatb", InventoryChangeTrigger.TriggerInstance.hasItems(TBlItems.LITHIUM_BATTERY_STACK_BOOSTED))
        ...
        AdvancementHolder find_lab = Advancement.Builder.advancement()
                .parent(make_battery)
                .display(
                        new ItemStack(TBlBlocks.LAB_BLOCK.get()),
                ...
                .addCriterion(
                        ...
                        PlayerTrigger.TriggerInstance.located(
                                LocationPredicate.Builder.inStructure(structures.getOrThrow(TBlStructures.LAB_RUINS))
                        )
                )
        ...
        AdvancementHolder enter_bl = Advancement.Builder.advancement()
                .parent(find_lab)
                .display(
                        new ItemStack(TBlBlocks.BL_PORTAL.get()),
                ...
                .addCriterion(
                        "bl",
                        PlayerTrigger.TriggerInstance.located(
                                LocationPredicate.Builder.inDimension(TBlDimensions.BLDIM_LEVEL_KEY)
                        )
                )
        ...
        AdvancementHolder kill_bl_monster = this.addBLKillable(registries, Advancement.Builder.advancement()
                .parent(enter_bl)
                .display(
                        new ItemStack(TBlItems.STEEL_SWORD.get()),
        ...
        AdvancementHolder bl_hunter = this.addBLKillable(registries, Advancement.Builder.advancement()
                        ...
                        .display(
                                new ItemStack(TBlItems.STEEL_AXE.get()),
        ...
        AdvancementHolder bl_explorer = this.addBLBiome(registries, Advancement.Builder.advancement()
                        .parent(enter_bl)
                        .display(
                                new ItemStack(TBlItems.STEEL_BOOTS.get()),
