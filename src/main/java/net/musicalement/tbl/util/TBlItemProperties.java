package net.musicalement.tbl.util;
...
public class TBlItemProperties {
    public static void addCustomItemProperties() {
        makeCustomBow(TBlItems.PROTOTYPE_002.get());
    }
    ...
    private static void makeCustomBow(Item item) {
        ItemProperties.register(item, ResourceLocation.withDefaultNamespace("pull"), (p_344163_, p_344164_, p_344165_, p_344166_) -> {
            if (p_344165_ == null) {
                ...
                return p_344165_.getUseItem() != p_344163_ ? 0.0F : (float)(p_344163_.getUseDuration(p_344165_) - p_344165_.getUseItemRemainingTicks()) / 20.0F * 0.5F;
            }
        });
